package com.todokanai.filemanager.test.adapters
...
import com.todokanai.filemanager.databinding.FilelistRecyclerDatabindingBinding
import com.todokanai.filemanager.test.Selection
import com.todokanai.filemanager.test.base.BaseAdapter
import com.todokanai.filemanager.test.base.BaseHolder
...
class SelectionAdapter : BaseAdapter<Selection>(SelectionItemCallback()) {
    ...
    override fun getItemViewType(position: Int): Int {
        return R.layout.filelist_recycler_databinding
    }

    inner class SelectionHolder(binding: FilelistRecyclerDatabindingBinding) : BaseHolder<FilelistRecyclerDatabindingBinding, Selection>(binding) {
